...
class LabReport(models.Model):
    ...
    thc-a = models.DecimalField(max_digits=4, decimal_places=2, blank=True, null=True)
    thc-v = models.DecimalField(max_digits=4, decimal_places=2, blank=True, null=True)
    cbd = models.DecimalField(max_digits=4, decimal_places=2, blank=True, null=True)
    cbd-a = models.DecimalField(max_digits=4, decimal_places=2, blank=True, null=True)
    cbd-v = models.DecimalField(max_digits=4, decimal_places=2, blank=True, null=True)
